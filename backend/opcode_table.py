...
SICXE_OPCODES = {
    **SIC_OPCODES,  # Copy all SIC opcodes into SIC/XE
    ...
    "MULI": "68",
    "RSUB": "4C",
    "TIXR": "B8",  # Fixed: Was incorrectly using same value as TIX
    "CLEAR": "B4",
    "SUBF": "5C",  # Fixed: Was using incorrect value
    # Additional SIC/XE opcodes can be added here
}
...
def save_optab(optab, folder):
    ...
    with open(optab_file, "w") as f:
        for instruction, opcode in sorted(optab.items()):
